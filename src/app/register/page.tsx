              ...
              <div className="mb-3 rounded-xl bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200/60 px-4 py-3">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-sm text-amber-900/90 leading-relaxed">
                    <strong className="font-semibold">Atención:</strong> El email de registro será utilizado como email de facturación. Si vas a pagar con Mercado Pago, usá el email asociado a tu cuenta de Mercado Pago.
                  </p>
                </div>
              </div>
