...
import { mockClientes, mockOrdenes } from '@/data/seedorData';
import { LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer } from 'recharts';

export default function VentasPageClient() {
    ...
    <div className="space-y-6">
      <header className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600">Resumen de ventas y clientes.</p>
        </div>
      </header>
