      ...
      <div className="flex items-center gap-4">
        ...
        <form className="flex items-center gap-3" action="/dashboard/usuarios">
          ...
          <Select name="role" defaultValue={params.role || 'ALL'}>
            <SelectTrigger className="w-[160px] !bg-white border-gray-200 cursor-pointer">
          ...
          <Select name="status" defaultValue={params.status || 'ALL'}>
            <SelectTrigger className="w-[140px] !bg-white border-gray-200 cursor-pointer">
        ...
        <Button variant="outline" className="gap-2 !bg-white border-gray-200 cursor-pointer hover:!bg-gray-50" disabled>
