...
export default function CTA() {
  ...
  return (
    <section id="cta" className="py-16 md:py-20 lg:py-24 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div
          ref={sectionRef}
          className={`relative overflow-hidden bg-gradient-to-br from-[#73AC01] to-[#5C8A01] rounded-[24px] md:rounded-[32px] p-8 sm:p-12 md:p-16 lg:p-20 text-center scroll-animate-scale ${isVisible ? 'visible' : ''}`}
        >
          ...
          <div className="relative z-10">
            ...
            <div
              className={`flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 scroll-animate-up ${isVisible ? 'visible' : ''}`}
            ...
            >
              ...
              <Link
                href="#demo"
                className="w-full sm:w-auto px-6 py-3 md:px-8 md:py-4 bg-white/10 text-white text-sm md:text-base font-semibold rounded-full border border-white/20 hover:bg-white/20 transition-all duration-300"
              >
                Ver demo
              </Link>
            </div>
